...
//     // Resize the canvas to half the video dimensions
//     const targetScale = 0.5; // Adjust the scale factor as needed
//     cv.width = element.videoWidth * targetScale;
//     cv.height = element.videoHeight * targetScale;

//     // Play the video
//     element.play();

//     // Optionally hide the video (keep height 0)
//     element.style.height = "0px"; // Hide video without stopping it

//     // Optional: Add resizing for the video (if required)
...
//     // Call additional processing function
//     playVids(element.id);
// }
